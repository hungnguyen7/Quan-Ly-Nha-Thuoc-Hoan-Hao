		...
		<div class="col-lg-12">
			<div class="panel panel-default">
                <div class="panel-heading">
                	<div class="row">
                		<div class="col-md-10">
                			<h3 class="panel-title">Quản lí nhà cung cấp</h3>
                		</div>
    		...
    		<form method="post" id="brand_form">
    			<div class="modal-content">
    				<div class="modal-header">
						...
						<h4 class="modal-title"><i class="fa fa-plus"></i>Thêm nhà cung cấp</h4>
    				</div>
    				<div class="modal-body">
    					...
    					<div class="form-group">
							<label>Nhập nhà cung cấp</label>
							<input value='Nhà thuốc Hoàn Hảo' type="text" name="brand_name" id="brand_name" class="form-control" required />
						</div>
    				</div>
