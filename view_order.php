			...
			<tr>
				...
				<table width="100%" cellpadding="5">
					<tr>
						<td width="65%">
							<b>Hóa đơn</b><br />
							Khách hàng : '.$row["inventory_order_name"].'<br />	
							Địa chỉ : '.$row["inventory_order_address"].'<br />
						</td>
						<td width="35%">
							Số hóa đơn : '.$row["inventory_order_id"].'<br />
							Ngày đặt : '.$row["inventory_order_date"].'<br />
						</td>
					</tr>
				</table>
				<br />
				<table width="100%" border="1" cellpadding="5" cellspacing="0">
					<tr>
						...
						<th rowspan="2">Giá</th>
						<th rowspan="2">Tổng (Giá x Số lượng)</th>
