                    ...
                    <div class="panel-heading">
                    	<div class="row">
                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
                            	<h3 class="panel-title">Quản lí thuốc</h3>
                            </div>
                        
                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6" align='right'>
                                <button type="button" name="add" id="add_button" class="btn btn-success btn-xs">Thêm</button>
                            </div>
                        </div>
                    </div>
                ...
                <form method="post" id="product_form">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title"><i class="fa fa-plus"></i>Thêm thuốc</h4>
                        </div>
                        <div class="modal-body">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon">
                                        <select name="product_unit" id="product_unit" required>
                                            ...
                                            <option selected value="Viên">Viên</option>
                            ...
                            <div hidden class="form-group">
                                <label>Thuế (%)</label>
                                <input type="text" name="product_tax" id="product_tax" class="form-control" required pattern="[+-]?([0-9]*[.])?[0-9]+" value='0' />
                            </div>
                        </div>
...
$(document).ready(function(){
    var productdataTable = $('#product_data').DataTable({
        ...
        "columnDefs":[
            ...
            {
				"name": "category_name", "targets": 1
			},
            {
				"name": "brand_name", "targets": 2
			},
            {
				"name": "product_name", "targets": 3
			},
            {
				"name": "product_quantity", "targets": 4
			},
            {
				"name": "product_enter_by", "targets": 5
			},
            {
				"name": "product_status", "targets": 6
			},
            {
                "targets":[7, 8, 9],
                "orderable":false,
    ...
    $('#add_button').click(function(){
        ...
        $('.modal-title').html("<i class='fa fa-plus'></i> Thêm thuốc");
        $('#action').val("Add");
        $('#btn_action').val("Add");
    });
